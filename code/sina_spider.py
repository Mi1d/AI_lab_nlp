...
if __name__ == '__main__':
    ...
    params = [  # pageid, lid, start_page(包含), end_page(不包含), save_path
        ('153', '2513', start_page, end_page, home_path + '娱乐.txt'),
        ('153', '2514', start_page, end_page, home_path + '军事.txt'),
        ('153', '2515', start_page, end_page, home_path + '科技.txt'),
        ('153', '2516', start_page, end_page, home_path + '财经.txt'),
        ('153', '2517', start_page, end_page, home_path + '股市.txt'),
        ('13', '585', start_page, end_page, home_path + '赛车.txt'),
        ('13', '571', start_page, end_page, home_path + '篮球.txt'),
        ('13', '572', start_page, end_page, home_path + '足球.txt'),
        ('13', '583', start_page, end_page, home_path + '跑步.txt'),
        ('13', '581', start_page, end_page, home_path + '彩票.txt'),
    ]
    print('program start...')
