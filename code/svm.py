...
def test_svm():
    ...
    print('overrall recall score:{:.6f}'.format(recall_score))
    print('----------------------')

    f1_score = metrics.recall_score(y_test, y_predict, average="micro")
    print('overrall f1_score:{:.6f}'.format(f1_score))
    print('----------------------')

    single_recall_score = metrics.recall_score(y_test, y_predict, average=None)
    print('recall score for each class:', single_recall_score)
    print('----------------------')
